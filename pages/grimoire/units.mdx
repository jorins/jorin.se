...
| Farenheit  | $\degree F$  | Exact origins vague, but temperature defined in relation to Celsius as $T_{\degree F} = \frac{5}{9}(x − 32) T_{\degree C}$    |
| Rankine    | $\degree Ra$ | As Kelvin is to Celsius, $T_{°Ra} = \frac{5}{9} \cdot T_K$                                                                    |
...
an ampere is technically defined directly as $6.241509074 \cdot 10^{18} \frac{e^-}{s}$.
